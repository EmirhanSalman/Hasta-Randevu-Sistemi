...
//							Maksimum muayne edilebilecek hasta sayýsý = 50




while(durum=='E' && sayac!=51){
	//                                                  Kullanýcýdan veriler isteniyor
...
//--------------------------------------------------------------------------------------------------------------------------DOKTOR BÝLGÝSÝ
    ...
    else if (strcmp (hasta[sayac].doktor_adi1 ,"Salih")==0)
    {
     ...
     printf("--> Gecersiz doktor adi. \nLutfen sadece bas harf buyuk olacak seklilde doktorun yalnýzca adini yaziniz");
    ...
    if (8<=hasta[sayac].saat && hasta[sayac].saat<17 && (doktor1.doktor_saatleri[hasta[sayac].saat] != 1 || doktor2.doktor_saatleri[hasta[sayac].saat] != 1)){
    ...
    else if(1 == doktor1.doktor_saatleri[hasta[sayac].saat] || 1 == doktor2.doktor_saatleri[hasta[sayac].saat])
    ...
    flag_saat = 0;
	sayac++;
// ---------------------------------------------------------------------------------------------------------------------  Yeni kullanýcý girilmek isteniyor mu?
